...
An autonomous Android device controller using multimodal AI agents. PhonePilot reads phone UI, plans actions, and executes them via ADB using a Plan -> Act -> Observe -> Verify loop.
...
5. Open [http://localhost:3000/phonepilot](http://localhost:3000/phonepilot)
