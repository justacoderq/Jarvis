...
class JiggleWiggleScreen extends StatefulWidget {
  const JiggleWiggleScreen({
    super.key,
  ...
  @override
  State<JiggleWiggleScreen> createState() => _JiggleWiggleScreenState();
}

class _JiggleWiggleScreenState extends State<JiggleWiggleScreen> {
